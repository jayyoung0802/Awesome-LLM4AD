...
- [Modular Autonomy with Conversational Interaction: An LLM-driven Framework for Decision Making in Autonomous Driving](https://arxiv.org/abs/2601.05806)
  ...
  - Summary：
    ...
    - Introduces a three-component methodology: a taxonomization of interaction categories, a Domain Specific Language (DSL) for command translation, and a safety-preserving validation layer.
...
- [SGDrive: Scene-to-Goal Hierarchical World Cognition for Autonomous Driving](https://arxiv.org/abs/2601.05640)
  ...
  - Summary：
    ...
    - Addresses the limitation of generalist VLMs in autonomous driving by providing structured spatial-temporal representations for safe trajectory planning.
    - Achieves state-of-the-art performance among camera-only methods on the NAVSIM benchmark, validating the effectiveness of hierarchical knowledge structuring.
...
- [LatentVLA: Efficient Vision-Language Models for Autonomous Driving via Latent Action Prediction](https://arxiv.org/abs/2601.05611)
  ...
  - Summary：
    - LatentVLA, a novel framework employing self-supervised latent action prediction to train Vision-Language-Action (VLA) models without language annotations, eliminating linguistic bias.
    ...
    - Establishes a new state-of-the-art on the NAVSIM benchmark (PDMS score of 92.4) and demonstrates strong zero-shot generalization on nuScenes.
...
- [ThinkDrive: Chain-of-Thought Guided Progressive Reinforcement Learning Fine-Tuning for Autonomous Driving](https://arxiv.org/abs/2601.04714)
  ...
  - Summary：
    ...
    - The method employs a two-stage training strategy: supervised fine-tuning using CoT explanations, followed by progressive RL with a difficulty-aware adaptive policy optimizer that adjusts learning intensity based on sample complexity.
...
- [UniDrive-WM: Unified Understanding, Planning and Generation World Model For Autonomous Driving](https://arxiv.org/abs/2601.04453)
  ...
  - Summary：
    ...
    - Experiments on Bench2Drive show improvements of 5.9% in L2 error and 9.2% in collision rate over prior methods, demonstrating the advantage of integrated reasoning, planning, and generative modeling.
...
- [Modular Autonomy with Conversational Interaction: An LLM-driven Framework for Decision Making in Autonomous Driving](https://arxiv.org/abs/2601.05806)
  ...
  - Summary：
    ...
    - Employs a two-stage LLM architecture to ensure high transparency and provide execution feedback, with evaluation confirming timing efficiency, translation robustness, and successful command execution across all interaction categories in simulation.
...
- [SGDrive: Scene-to-Goal Hierarchical World Cognition for Autonomous Driving](https://arxiv.org/abs/2601.05640)
  ...
  - Summary：
    ...
    - Addresses limitations of generalist VLMs by providing structured spatial-temporal representations for safe trajectory planning in autonomous driving.
    - Achieves state-of-the-art performance among camera-only methods on the NAVSIM benchmark, validating the effectiveness of hierarchical knowledge structuring.
...
- [LatentVLA: Efficient Vision-Language Models for Autonomous Driving via Latent Action Prediction](https://arxiv.org/abs/2601.05611)
  ...
  - Summary：
    ...
    - Establishes state-of-the-art on NAVSIM (PDMS: 92.4) and shows strong zero-shot generalization on nuScenes.
...
- [ThinkDrive: Chain-of-Thought Guided Progressive Reinforcement Learning Fine-Tuning for Autonomous Driving](https://arxiv.org/abs/2601.04714)
  ...
  - Summary：
    ...
    - Results show ThinkDrive outperforms strong RL baselines on key metrics and a 2B-parameter model trained with this method surpasses the much larger GPT-4o by 3.28% on the exam metric.
